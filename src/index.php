...
?>
  ...
  <div class="hoverme">
        <li>2017 - <strong>Bac STIDD - Lycée Louis Couffignal</strong> - Strasbourg</li><br />
          <img class="imagelycee" src="img/logolyceecouff.jpg" alt="Logo Lycée" title="Le logo du lycée !" style="width: 850px;">
          <img class="imagelycee" src="img/lyceecouff.jpg" alt="Lycée" title="Le lycée !" style="width: 530px;">

  </div> <br />

	<div class="hoverme2">
        <li style="margin-right: 10px;">2013 - <b>Brevet des collèges - Collège des Roseaux</b> - Illkirch</li><br />
          <img class="imagecollege" src="img/college.jpg" alt="Collège" title="Le collège !" style="width: 530px; margin-right: 20px;">
          <img class="imagecollege" src="img/roseaux.jpg" alt="Collège" title="Panneau du collège !" style="width: 530px; margin-left: 20px;"><br /><br />
  ...
  <div id="conteneurDrap">
	...
	<div class="hidden" id="coord">
      ...
      <form method="post" action="CibleFormulaire.php" enctype="multipart/form-data" id="contactform">
           ...
           <label for="ladate">Si oui, a quelle date ? </label><input id="ladate" name="ladate" type="date" value="<?php echo $date ?>"/><br />
           <br />

          <label for="email">Envoyer ceci par email</label> : <input type="email" id="email" name="email" value="corentin.milot@free.fr"/><br />
          <br />
   ...
   <br />   <br />   <br />   <br />   <br />
      ...
      Corentin MILOT<br/>
	    ...
	    <a class ="mail" href="mailto:corentin.milot@free.fr">corentin.milot@free.fr</a><br/>
...
$reponse = $bdd->query('SELECT nom, textadresse, tel, ladate, email FROM Formulaire');
?>
  </body>
